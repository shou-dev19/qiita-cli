...
tags:
  ...
  - 初心者
private: false
updated_at: '2026-08-21T15:37:42+09:00'
...
### 別のたとえで言うと：モデル＝言語、ハーネス＝フレームワーク

ちなみにこのハーネスの話、実は私たちエンジニアが、AIとはまったく関係のないところで、もう何十年も繰り返してきた構造と同じです。**別のたとえで言い換えてみます。**

> ### **モデル = プログラミング言語。ハーネス = フレームワーク。**

私たちは何かシステムを実装するとき、超頭の良い人たちが設計してくれた**言語**と**フレームワーク**の上に乗って開発してきました。言語だけを使って0からシステムを組み上げるより、フレームワークの流儀に従って書き始めたほうが、圧倒的に速く、品質の高いものが作れる——これはエンジニアであれば誰もが体感してきた経験則です。

ただし、フレームワークはあくまで**汎用的な骨組み**でしかありません。フレームワークだけではプロダクトは1つも生まれない。**そこにドメイン知識を肉付けし、クリーンアーキテクチャのような設計思想に則って"きれいな設計・きれいなコーディング"をする**——これが、これまでのエンジニアの本業でした。

**これからのAI時代は、まったく同じ営みを「ハーネス」に対して行う必要がある。** Anthropicのような超頭の良い人たちが作ってくれた Claude Code というハーネス（フレームワーク）のベストプラクティスに則り、そこにドメイン知識を"きれいな設計"で肉付けしていく。

私たちがこれまで見て・作ってきたレイヤーは「プログラミング言語」であり「フレームワーク」でした。それが今、**もうひとつ上の「ハーネス」というレイヤーに移りつつある。** これが、この記事を通していちばん伝えたいことです。

![図2-5 モデルは言語、ハーネスはフレームワーク](https://raw.githubusercontent.com/shou-dev19/qiita-cli/main/images/ai-driven-development-glossary-2/part2-r2-fig02-5.png)

*図2-5｜これまでは言語とフレームワークの上に設計を積んできた。これからはモデルとハーネスの上に同じことをする*
...
**エンジニアの経験は、AI時代にちゃんと効きます。** 言語とフレームワークの上で積み上げてきた"きれいな設計"の作法を、そのままハーネスの上でもう一度やるだけ。ここは自信を持っていい部分だと思っています。
